...
- Currently hardcoded to: `01f0488564b11b5faa935a71e74cf52f`
...
- **Genie Space ID**: `01f0488564b11b5faa935a71e74cf52f`
- **Databricks Host**: `https://e2-dogfood.staging.cloud.databricks.com`
- **Polling Timeout**: 10 minutes (600 seconds)
- **Initial Delay**: 5 seconds
- **Max Delay**: 60 seconds
- **Database**: `genie_conversations.slack_genie_conversations`
- **Error Workflow ID**: `0au2Qpgb2uPuSaDz` (Slack Genie Error Workflow)
